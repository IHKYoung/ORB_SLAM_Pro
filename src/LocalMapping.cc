...
namespace ORB_SLAM3
{
    ...
    void LocalMapping::RequestReset()
    {
        {
            unique_lock<mutex> lock(mMutexReset);
            cout << "LocalMapping: Map reset received" << endl;
            mbResetRequested = true;
        }
        cout << "LocalMapping: Map reset, waiting..." << endl;
        ...
        cout << "LocalMapping: Map reset, Done!!!" << endl;
    }
    ...
    void LocalMapping::RequestResetActiveMap(Map *pMap)
    {
        {
            unique_lock<mutex> lock(mMutexReset);
            cout << "LocalMapping: Active map reset received" << endl;
            mbResetRequestedActiveMap = true;
            mpMapToReset = pMap;
        }
        cout << "LocalMapping: Active map reset, waiting..." << endl;
        ...
        cout << "LocalMapping: Active map reset, Done!!!" << endl;
    }
    ...
    void LocalMapping::ResetIfRequested()
    {
        bool executed_reset = false;
        {
            ...
            if (mbResetRequested)
            {
                ...
                cout << "LocalMapping: Reseting Atlas in Local Mapping..." << endl;
                mlNewKeyFrames.clear();
                ...
                cout << "LocalMapping: End reseting Local Mapping..." << endl;
            }

            if (mbResetRequestedActiveMap)
            {
                executed_reset = true;
                cout << "LocalMapping: Reseting current map in Local Mapping..." << endl;
                mlNewKeyFrames.clear();
                mlpRecentAddedMapPoints.clear();
        ...
        if (executed_reset)
            cout << "LocalMapping: Reset free the mutex" << endl;
    }
